...
const STRINGS = {
  en: {
    ...
    'alloc.tcpRange': 'This server allocates TCP ports {min}-{max}.',
    ...
    'alloc.saved': 'Allocation updated. A connected machine keeps its current limit until it reconnects.',
    ...
    'client.saved': 'Credential updated. A connected machine keeps its current limit until it reconnects.',
  ...
  'pt-BR': {
    ...
    'alloc.tcpRange': 'Este servidor aloca portas TCP de {min} a {max}.',
    ...
    'alloc.saved': 'Alocação atualizada. Uma máquina conectada mantém o limite atual até reconectar.',
    ...
    'client.saved': 'Credencial atualizada. Uma máquina conectada mantém o limite atual até reconectar.',
